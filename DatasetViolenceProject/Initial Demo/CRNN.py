...
# set path
data_path = "dataset_jpeg/"    # define UCF-101 RGB data path
...
begin_frame, end_frame, skip_frame = 1, 100, 2
...
action_names = ['violence', 'non_violence']
...
for f in fnames:
    loc1 = f.find('jpeg/')
    loc2 = f.find('lent/')
    actions.append(f[(loc1 + 5): (loc2+4)])
